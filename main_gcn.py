...
def parse_args():
    ...
    parser.add_argument('-hid', '--hid_dim', default=128, type=int, metavar='N', help='num of hidden dimensions')
...
def main(args):
    ...
    if args.resume or args.evaluate:
        ...
        glob_step = 0
        lr_now = args.lr
        ckpt_dir_path = path.join(args.checkpoint, datetime.datetime.now().isoformat() + "_l_%04d_hid_%04d_e_%04d_non_local_%d" % (args.num_layers, args.hid_dim, args.epochs, args.non_local))
