...
def show3Dpose(channels, ax, add_labels=False): # blue, orange
  """
  ...
  I   = np.array([3,2,1,0,4,5,0,7,8,16,15,14,9,11,12,9]) # start points
  J   = np.array([2,1,0,4,5,6,7,8,9,15,14,9,11,12,13,10]) # end points
